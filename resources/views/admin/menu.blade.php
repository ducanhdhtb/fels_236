<div class="navbar-default sidebar" role="navigation">
    <div class="sidebar-nav navbar-collapse">
        <ul class="nav" id="side-menu">
            ...
            <li>
                <a href="#"><i class="fa fa-bar-chart-o fa-fw"></i> SubCategory<span class="fa arrow"></span></a>
                <ul class="nav nav-second-level">
                    <li>
                        <a href="{{ route('subcategory.list') }}">List SubCategory</a>
                    </li>
                    <li>
            ...
            <li>
                ...
                <ul class="nav nav-second-level">
                    ...
                    <li>
                        <a href="{{ route('order.add') }}">Add Order</a>
                    </li>
                </ul>
                <!-- /.nav-second-level -->
            </li>
            <li>
                ...
                <ul class="nav nav-second-level">
                    <li>
                        <a href="{{ route('orderdetail.list') }}">List Order details</a>
                    </li>
                    <li>
                        <a href="{{ route('orderdetail.add') }}">Add order details</a>
                    </li>
                </ul>
                <!-- /.nav-second-level -->
            </li>
            <li>
                ...
                <ul class="nav nav-second-level">
                    <li>
                        <a href="{{ route('comment.list') }}">List Comment</a>
                    </li>
                    <li>
                        <a href="{{ route('comment.add') }}">Add Comment</a>
                    </li>
                </ul>
                <!-- /.nav-second-level -->
            </li>
