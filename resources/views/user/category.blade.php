    ...
    <div class="content">
        ...
        <div class="product">
            <div class="title-product">
                <div class="col-md-6">
                    <h3>Category:drink-Orange Juice</h3>    
                </div>
            ...
            <div class="col-md-3">
                <a href="#" class="thumbnail">
                    <img src="user_asset/img/product_1.png" alt="...">
                </a>
                <p align="center">Baseball</p>
                <div class="add-cart">
                    <h4 style="display: inline;">$20</h4>
                ...
                <div class="col-md-3">
                    ...
                    <p align="center">Baseball</p>
                    <div class="add-cart">
                        <h4 style="display: inline;">$20</h4><button type="button" class="btn btn-default pull-right"><i class="glyphicon glyphicon-shopping-cart"></i> Add to cart</button>
                    </div>
                    <div class="clearfix"></div>
                </div>
                <div class="col-md-3">
